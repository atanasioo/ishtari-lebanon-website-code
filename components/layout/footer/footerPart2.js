              ...
              <div className={` flex  `}>
                <ul className="flex px-6 flex-wrap justify-center items-center">
                  ...
                  <li className="flex rounded-sm items-center justify-center text-center mx-1.5 ">
                    <img className={`h-5 w-11`} src={"/images/mastercard.svg"} alt="mastercard_payment" />
                  </li>
                  <li className="flex rounded-sm items-center justify-center text-center mx-1.5 ">
                    {" "}
                    <img className={`h-5 w-11`} src={"/images/visa.svg"} alt="visa_payment"/>
                  </li>
                  <li className="flex rounded-sm items-center justify-center text-center mx-1.5 ">
                    {" "}
                    <img className={`h-4 w-11`} src={"/images/cash.svg"} alt="cash_payment"/>
                  </li>
                  <li className="flex rounded-sm items-center justify-center text-center mx-1.5 ">
                    {" "}
                    <img className={`h-5 w-11`} src={"/images/amex.svg"} alt="american_express_payment"/>
                  </li>
                </ul>
              </div>
            )}
