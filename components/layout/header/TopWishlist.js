  ...
  return (
    <div className="flex">
      <Link
        ...
        } text-white font-semibold text-base flex items-center h-8 pr-3 sm:px-5 cursor-pointer hover:opacity-80  md:text-white text-base pl-1.5 sm:pl-3 sm:pr-6 transition ease-in-out duration-300 delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 relative`}
...
<Link
  ...
  className={`${window.config["showCart"] ? "block" : "hidden"} font-extrabold  md:text-white text-base flex items-center pl-1.5 pr-1 sm:pl-3 sm:pr-6 cursor-pointer  hover:opacity-70 transition ease-in-out duration-300 delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 relative`}
  href={`${path}/account/wishlist`}
>
  <span className="hidden xl:block lg:block">Wishlist</span>
  <FiHeart
