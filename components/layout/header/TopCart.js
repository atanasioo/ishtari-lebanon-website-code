...
function TopCart() {
    ...
    return (
        <Link className={`${"window.config[showCart]"==1 ? 'block' : 'block'} font-semibold text-base flex items-center pl-1.5 pr-3 sm:pl-3 sm:pr-6 cursor-pointer hover:opacity-80 relative`} href={`${path}/cart`}>
