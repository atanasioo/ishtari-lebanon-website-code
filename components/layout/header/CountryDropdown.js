...
function CountryDropdown(props) {
  ...
  return props.host === "https://www.ishtari.com" ||
    ...
    <div className="flex justify-center max-md:mx-2  md:mx-3">
      <div>
        <div className="dropdown relative float-right lg:pr-2">
            ...
            {props.host === "https://www.ishtari.com" ? (
              <div className=" flex  p-1 sm:p-3">
                <img
                  ...
                  alt="Lebanon"
                />{" "}
                <span className="ml-3 hidden mobile:block"> Lebanon</span>
              </div>
            ) : (
              <div className="flex p-1 sm:p-3">
                <img
          ...
          {int ? (
            <ul
              ref={wrapperRef}
              className="dropdown-menu min-w-max absolute right-0 bg-white text-base z-[999] float-left py-3 px-3 list-none text-left rounded-sm shadow-lg"
            >
              <li>
                <a
                  className="flex py-3 pl-2 pr-3 hover:bg-dgrey1 hover:bg-opacity-10 hover:text-dbase"
                ...
                >
                  ...
                  <span class="ml-2 mr-2 transition-all duration-300 ease-in-out ">
                    Lebanon
                  </span>
                </a>
              </li>
              <li>
                ...
                >
                  <img
                    ...
                    alt="ghana"
                  />{" "}
                  <span className="ml-2 mr-2 transition-all duration-300 ease-in-out ">
                    {" "}
                    Ghana
                  </span>
                </a>
