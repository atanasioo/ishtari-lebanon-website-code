...
export default function reviewSellerPlaceholderMobile() {
  return (
    <div className="container">
      <div className="placeholder_animation relative w-full h-40 flex justify-center items-center text-6xl uppercase font-sans bg-dlabelColor bg-opacity-30">
        <div className="absolute z-20 rounded-full w-28 h-28 border-4 border-white -bottom-16 left-10 text-d18 flex items-center justify-center bg-white placeholder_animation">
          {" "}
        </div>
      </div>
      <div className="flex  flex-col mt-12">
        <div className="flex  flex-col w-full">
          <div className="w-full border border-dgrey1 text-d14 flex flex-col rounded-lg border-opacity-20 p-5 space-y-0.5">
            <span className="text-d16 pr-semibold text-dblackOverlay3 ">
              Seller Rating
            </span>
            <div className="w-full flex items-center pr-semibold h-12">
          ...
          <div className="w-full border border-dgrey1 text-d14 flex flex-col rounded-lg border-opacity-20 p-5 space-y-0.5 h-32">
        ...
        <div className="w-full flex flex-col  border-dgrey1 border-opacity-20 mt-12">
          <div className="text-d22 pr-semibold px-2">
            Seller Ratings & Reviews
          </div>
          <div className=" flex flex-col  border-dgrey1 border-opacity-10 pl-2 space-x-5 mt-5">
            <div className="flex justify-end flex-col mb-8">
              <div className=" pr-semibold text-5xxl h-8 py-6 mb-5  bg-dlabelColor bg-opacity-10 placeholder_animation w-24"></div>
