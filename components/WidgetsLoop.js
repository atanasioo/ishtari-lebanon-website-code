...
function WidgetsLoop({ widget, likedData, bannerStats }) {
  ...
  // useEffect(() => {
  //   if (Object.keys(bannerStats).length > 0 && accountState.admin) {
  //     const stats = bannerStats.find(
  //       (stats) => stats.banner_image_id === widget.banner_image_id
  //     );
  //   }
  // }, [bannerStats]);
                    ...
                    >
                      ...
                      {showStats &&
                        ...
                        bannerStats.some(
                          ...
                          <div
                            className="absolute z-10 bottom-5 right-3 text-d13 px-2.5 py-1.5 pr-semibold rounded-full"
              ...
              return item.mobile_type_id !== "0" ? (
                ...
                >
                  <Link
                    ...
                    className="w-full link-span relative"
                  >
                    <Image
                      alt={item?.name}
                      src={host.host + "/image/" + item.image}
        ...
        <div className="flex -mx-4 flex-wrap justify-between">
          {widget.items.map((item) => {
            ...
            return item.mobile_type_id !== "0" ? (
              ...
              <div
                className={`hover:opacity-80 relative w-1/${widget.column_number} md:w-1/${widget.column_number}`}
                key={item.banner_image_id}
              >
                <Image
                  alt={item?.name}
