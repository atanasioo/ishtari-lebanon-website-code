              ...
              <div className="w-full h-full">
                ...
                >
                  ...
                  <div className="flex flex-row pb-7 relative">
                      ...
                      <div className="flex mt-2">
                        <div className="h-1 w-full bg-dTransparentWhite1 mt-2">
                          <div
                            ...
                            style={{
                              width:
                                state?.data?.current_point_precentage + "%",
                            }}
                          ></div>
                        </div>
                    ...
                    <div
                      onClick={goTo}
                      className="flex  justify-between starts-div absolute z-10 rounded-lg bg-white text-dgreyProduct text-sm md:text-d14 shadow-md  px-6 py-1.5 -bottom-10 w-full"
                    >
